...
function CustomerFormPage() {
  ...
  useEffect(() => {
    ...
    if (c) {
      setInitial({
        company: c.company, email: c.email, contactName: c.contactName, contactPhone: c.contactPhone,
        address: c.address, taxCode: c.taxCode, legalRep: c.legalRep,
      });
  ...
  function save(d: FormData) {
    ...
    const data = {
      ...
      taxCode: (d.taxCode || "").trim() || undefined,
      legalRep: (d.legalRep || "").trim() || undefined,
      progress: cleaned,
    };
